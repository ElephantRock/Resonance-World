# ruff: noqa: I001,E501
"""Per-probe execution for #270 canonical-JSON prompt conformance."""
...
from d2_canonical_json_prompt_agent import new_agent
...
def _decision(
    ...
    return adapter.evaluate_terminal_completion(
        ...
        parse_valid=bool(row["exact_structured_parse_valid"]),
