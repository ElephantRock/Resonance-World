# ruff: noqa: I001,E501
"""Deterministic fresh D2-shaped prompts for #273 JSON-skeleton qualification."""
...
from d2_json_skeleton_spec import NAMESPACE, SYSTEM_PROMPT_SHA256, sha
...
def synthetic_strategy(seed: int, budget: int) -> str:
    return (
        f"skeleton-b{budget}-s{seed}; anchor-{adapter.ACTIONS[(seed + 1) % 4].lower()}; "
