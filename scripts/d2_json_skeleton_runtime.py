"""One-shot execution aggregation for #273 JSON-skeleton conformance."""
...
import d2_json_skeleton_transport as transport
from d2_json_skeleton_agent import new_agent, preflight, request_overrides
from d2_json_skeleton_probe import apparatus_failure, run_probe
...
def execute() -> dict[str, Any]:
    ...
    return {
        "schema": "d2-json-skeleton-result-v0.1",
