...
'scripts/d2_projection_spec.py':'3c1dea592905433c70bd5c879e6459bec9b18d30',
'scripts/d2_projection_prompts.py':'d80d8e162ae96e22c50bdef817aa47162359f78a',
'scripts/d2_json_mode_contract.py':'861505a562e790bad6e6b828bd4554115c624800',
'scripts/d2_json_mode_transport.py':'001208db3b99e67717129ef481a2bb74c4d0a718',
'scripts/d2_json_mode_agent.py':'bc1be7e8776ceb4567bdd7c98aa524635338383c',
...
'scripts/d2_projection_verify_result.py':'aeff0b3fb36017dce932de8aa2e6935e5e5740af',
'tests/test_d2_top_level_projection.py':'93963e360e39c25520d3b97133043c19361aec14',
...
def main()->int:
 ...
 if int(run(*q,'reviews','--repository',repo,'--pull-request','265','--candidate-sha',c))<1: raise SystemExit('exact-head review absent')
 if int(run(*q,'threads','--repository',repo,'--pull-request','265'))!=0: raise SystemExit('unresolved review thread')
