#!/usr/bin/env python3
"""Deterministically evaluate canonical D2-C2 confirmatory provider output."""
...
import run_d2_c2_confirmatory as runner
...
def _global_integrity(
    ...
    *,
    ...
    defects: list[str] = []
    if provider.get("schema") != "d2-c2-confirmatory-provider-output-v0.1":
...
def evaluate(
    ...
    *,
    ...
    result = {
        "schema": "d2-c2-confirmatory-result-v0.1",
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="output/d2-c2-confirmatory-evaluation",
    )
    parser.add_argument(
        "--plan",
    ...
    result_path = output_dir / "d2-c2-confirmatory-result.json"
    result_path.write_bytes(canonical_bytes(result))
    manifest = {
        "schema": "d2-c2-confirmatory-evaluation-manifest-v0.1",
