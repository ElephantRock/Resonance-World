...
def main() -> int:
    ...
    checks = {
        ...
        "contextgraph_release_commit": (
            manifest.get("contextgraph_release_commit") == CG
        ),
        ...
        == {"f0": 16, "f1": 16, "f2": 16},
        "t50_family_balance": fixture.get("t50_replaced_by_family")
        == {"f0": 8, "f1": 8, "f2": 8},
        "turnover_counts": fixture.get("turnover_replaced_counts")
        == {"t0": 0, "t50": 24, "t100": 48},
        "result_limit": fixture.get("result_limit") == 2,
        "correct_action_balance": fixture.get("correct_action_balance")
        == {"lexicographic_first": 24, "lexicographic_second": 24},
        "record_counts": (
        ...
        "plane_e_no_evaluator_labels": all(
            ...
            and "private_sentinel" not in row
